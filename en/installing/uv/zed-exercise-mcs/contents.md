...
- macOS and Linux: `~/Programming/MCS/module1`
- Windows: `$HOME\Programming\MCS\module1`
...
In the sidebar, open `MCS` and then `module1`. Do right-click on `module1` and choose *New File*. Name it `test.txt` and type this as its content:
