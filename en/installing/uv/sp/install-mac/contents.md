...
This file lists the packages you need for this course. Save it in your course folder, so that you have `~/Programming/SP/requirements.txt`.
...
3. Go to the folder you are working in, for example `cd ~/Programming/SP/module1`.
